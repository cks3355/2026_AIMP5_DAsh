...
# DAsh: Pi-mono Super Agent routing + LangGraph Sub Agent prototype v6.
#
...
#
# 실행 방법:
#     streamlit run 05.09_prompt_v6.py
#     python 05.09_prompt_v6.py "작업이 시작된 일시"
#     python 05.09_prompt_v6.py --docs
...
def build_runtime() -> Runtime:
    ...
    return Runtime(config, repo, vector, PiMonoSuperAgent(DashGraph(tools), llm), ProjectDocuments.load())
...
def run_cli(args: list[str]) -> int:
    ...
    if "--docs" in args:
        ...
        print("\n실행 방법: streamlit run 05.09_prompt_v6.py")
        return 0
